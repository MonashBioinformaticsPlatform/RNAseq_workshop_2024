...
![](images/featureCounts_assignment.svg)
...
Use the search box at the top of the IGV viewer to find one of:
  ...
  - `GNRH1` (`ENSG00000147437`) is a good example gene since it's short with only one intron, and has few reads (SRR2155413 = 6 reads)
  - `GHET1` (`ENSG00000281189`) lncRNA is also an easy one to count  (SRR2155413 = 7 reads)
  - `INSL3` (`ENSG00000248099`)  (SRR2155413 = 5 reads) - most mapped to the second intron and not counted. The counted reads are in exon3 and the 3' UTR.
