...
There are two main aspects to planning an RNAseq experiment:
...
The most common type of analysis performed with RNAseq data is differential gene expression (DGE) analysis. This analysis looks at the difference in abundance for genes between 2 or more conditions. However it is not the only type of differential test that can be performed with RNAseq data.
