...
- quantatively: how much is expressed? Specifically, has the amount changed in response to a variable? RNAseq provides *expression* information.

This capability for simultaneous discovery and quantification at the whole transcriptome is a key reason that cemented RNAseq as the technology of choice for studying RNA. Previous technologies such as microarrays used probes based on already known genes. 

```{r, fig.cap="", echo=FALSE, out.width="100%", fig.cap="RNAseq captures two layeres of information: what is expressed and how much is expressed"}
knitr::include_graphics("https://images.squarespace-cdn.com/content/v1/59a1d86e6a49631dd51560f2/1546220317582-R09TS3DSWVDNADNQ3M1S/Figure1-01.png?format=2500w")
```

Image source: [Compbio 022: Differential splicing and transcripts - Not as simple as it first appears](https://www.badgrammargoodsyntax.com/compbio/2018/12/31/compbio-022-differential-splicing-and-transcripts-not-as-simple-as-it-first-appears)


The most common use is quantative analysis of gene expression changes, though isoform level differential analysis can also be performed. RNAseq can simultaneously be used for discovery, such as detection of novel transcripts, alternate splicing, exon skipping, intron retention or fusion genes. In organisms without a reference genome, RNAseq data can be used for de novo transcriptome assembly. 
...
Long read sequencing is ideal for isoform/transcript level analyses as there is no ambiguity to which isofrom a read comes from, if the entire isoform has been sequenced. 
