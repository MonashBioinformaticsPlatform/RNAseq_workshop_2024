...
```{r, echo=FALSE, fig.align="center", fig.cap="Overview of RNAseq with short read/long read technologies", out.width="70%"}
...
The most common type of analysis performed with RNAseq data is differential gene expression (DGE) analysis. This analysis looks at the difference in abundance for genes between conditions. However it is not the only type of differential test that can be performed in 

```{r, echo=FALSE, fig.align="center", fig.cap="The different types of differential expression analysis"}
