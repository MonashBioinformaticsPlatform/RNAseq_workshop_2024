...
```{r, echo=FALSE, fig.align="center", fig.cap="Overview of RNAseq with short read/long read technologies", out.width="85%"}
...
```{r, echo=FALSE, fig.align="center", fig.cap="The different types of differential expression analysis", out.width="70%"}
