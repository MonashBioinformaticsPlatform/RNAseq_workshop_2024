...
knitr::include_graphics("images/overview_rnaseq.png")
```
...
These descriptions of RNAseq are not mutually exclusive and are in fact used in combination with each other. A short read library with paired ends can be generated with polyA pulldown.
...
<table class="tg"><tbody>
  <tr>
    <td class="tg-0pky">Biological material<br></td>
    <td class="tg-0pky">Entire tissue: Bulk RNAseq</td>
    <td class="tg-0pky">Individual cells: Single cell RNAseq</td>
    <td class="tg-0pky"></td>
  </tr>
  <tr>
    <td class="tg-0pky">RNA species sequenced</td>
  ...
  <tr>
    <td class="tg-0pky">Library Strandedness</td>
  ...
  <tr>
    <td class="tg-0pky">Which end of the fragment is sequencing<br></td>
...
Lastly, we can look at whether transcript levels are changing, regardless of the gene of origin.
