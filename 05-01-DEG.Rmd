...
"Min gene CPM" setting:

* So as to require about a count of 10 (check the library size QC plot).
* The author of Degust says 0.5 or 1 is usual.
...
* The author of Degust recommends around 2/3 or the smallest group size.
